...
namespace Fiap.Health.Med.Application.Features.Medicos.Commands.AdicionarMedico
{
    public class AdicionarMedicoCommandValidator : AbstractValidator<AdicionarMedicoCommand>
    {
        public AdicionarMedicoCommandValidator()
        {
            RuleFor(x => x.Nome)
