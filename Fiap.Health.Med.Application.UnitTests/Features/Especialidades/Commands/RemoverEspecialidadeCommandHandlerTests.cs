using Fiap.Health.Med.Application.Features.Especialidades.Commands.RemoverEspecialidade;
using Fiap.Health.Med.Domain.Entity;
using Fiap.Health.Med.Domain.Interfaces;
using Moq;
using Moq.AutoMock;

namespace Fiap.Health.Med.Application.UnitTests.Features.Especialidades.Commands
{
