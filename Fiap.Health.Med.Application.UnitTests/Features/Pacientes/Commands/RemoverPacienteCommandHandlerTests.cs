using Fiap.Health.Med.Application.Features.Pacientes.Commands.RemoverPaciente;
...
namespace Fiap.Health.Med.Application.UnitTests.Features.Pacientes.Commands
{
