using Fiap.Health.Med.Application.Features.Agendamentos.Commands.AdicionarAgendamento;
using Fiap.Health.Med.Application.Features.Agendamentos.Commands.AtualizarAgendamento;
using Fiap.Health.Med.Application.Features.Agendamentos.Commands.RemoverAgendamento;
using Fiap.Health.Med.Application.Features.Agendamentos.Queries;
using MediatR;
